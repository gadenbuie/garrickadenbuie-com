...
{{% youtube "-QgJgZCJvo4" %}}
<caption>
*I challenged The CSS King to a CSS Battle* on [YouTube](https://youtu.be/-QgJgZCJvo4)
</caption>
</figure>
...
<svg xmlns="http://www.w3.org/2000/svg" class="sidenote-pair-programmers" viewBox="0 0 512 512">
<title>
ionicons-v5-j
</title>
