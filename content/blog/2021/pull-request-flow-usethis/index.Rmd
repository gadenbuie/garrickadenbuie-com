...
The [[usethis]]{.pkg} package is full of incredibly helpful functions
...
There are other great resources available in the [usethis]{.pkg} documentation.
...
::: decision
`r way_point()` TK where next
:::

## Open your PR on GitHub {#pr-view-theirs .step}
