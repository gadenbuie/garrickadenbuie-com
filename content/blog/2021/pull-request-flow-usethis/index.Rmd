...
<span id="instructions-non-interactive">You don't need to read this one from top to bottom.
Instead, jumping around is encouraged!</span>
<span id="instructions-interactive">It's a little bit unusual, but don't worry, I'll walk you through it.</span>
...
1. [Review someone else's work](#pr-fetch-review)
:::
...
::: decision
`r way_point()` You're ready to <a href="#do-work" class='clear-steps'>do some work</a>.
:::
...
We picked option `1` to keep working in our `add-examples` branch.
Notice that, since `add-examples` is related to PR `#11`,
`pr_resume()` also did you the extra favor of
making sure that your local copy is up-to-date.

::: decision
`r way_point()` Rock and roll, you're ready to <a href="#do-work" class='clear-steps'>do some work</a>.
:::
...
::: decision
`r way_point()` Sweat deal! Okay, you're ready to <a href="#do-work" class='clear-steps'>do some work</a>.
:::

### Review someone else's work {#pr-fetch-review .step}

TK: intro text about reviewing work
...
TK: intro text about making a remote branch local to your machine.
...
::: decision
`r way_point()` All set! Now you're ready to <a href="#do-work" class='clear-steps'>do some work in this branch</a>.
:::
...
- The one I'm in right now, so
  <a class="clear-steps" href="#do-work">I'm ready to get to work</a>!
...
- If **not**, no worries. Just <a href="#do-work" class="clear-steps">keep on working</a>.
:::
...
Before you move on, 
you probably want to put aside the thing you were just working on.
Don't worry,
it will be waiting patiently for you in a local branch
...
::: decision
`r way_point()` <a href="#start" class="clear-steps">Go back to Start</a> to decide to decide what's next in your adventure.
:::
...
::: decision
`r way_point()` <a href="#start" class="clear-steps">Go back to Start</a> to decide what's next in your adventure.
:::
...
<div id="story-reset"><a href="#intro" class="clear-steps"><i aria-hidden="true" class="fas fa-undo-alt"></i> Start over</a></div>
