...
<ul id="intro-options">
<li><p>Yes, [I'm ready to go](#start)!</p></li>
</ul>
:::
...
- The one that I'm in now, I'm ready to <a class="clear-steps" href="#do-work">get some work done and fix this thing</a>.
...
```{js, echo=FALSE, eval=identical(knitr::current_input(), "index.Rmd")}
(function() {
