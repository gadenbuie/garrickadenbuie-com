...
(function() {
  ...
  if (urlParams.get('interactive') == 0) {
  ...
  document
    ...
    .addEventListener('click', function(ev) {
      ...
      const stepIds = currentStory.map(el => el.id)
      if (!steps[stepId]) {
        console.warning(`Unknown step id #${stepId}, treating like a normal link`)
        return;
      }
      if (!stepIds.includes(stepId)) {
        ...
        const idxNext = stepIds.indexOf(stepId) + 1
