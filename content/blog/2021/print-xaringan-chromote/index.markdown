...
[^1]: I wasn’t really sure where to put this function. Maybe I’ll eventually add it to <span class="pkg">xaringanExtra</span>, but for now it’ll live here where hopefully it can still be useful to you!
