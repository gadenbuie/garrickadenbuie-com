...
xaringanExtra::use_clipboard(selector = 'pre[class]')
```
...
[^or-keybase-app]: You can create a GPG/PGP key in the app too in the identities section of your profile, but I'm using the command line so it's easier to copy-paste.
