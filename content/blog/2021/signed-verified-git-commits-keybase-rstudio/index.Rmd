...
One advantage of Keybase is that the its app and command line
make it relatively easy to generate and store.
It's also a great way to share your key between your own computers.

### Create a PGP key with Keybase
...
head back to the command line to create a new GPG key.
...
Remember that console dialog that appeared when we commited our test commit above?
