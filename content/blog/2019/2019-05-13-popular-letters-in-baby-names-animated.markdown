...
I’m also a big fan of <span class="pkg"><span class="pkg">gganimate\]</span> - check out my first project with \[gganimate</span>, a collection of [join animations called *tidyexplain*](https://github.com/gadenbuie/tidyexplain).
...
These two sister packages are my go-to packages for reliably being able to use <span class="pkg">Google Fonts\][google-fonts](https://fonts.google.com/) with \[ggplot2</span> on any system.
