...
The rest of this post describes this workflow in more detail, including how to configure [critical settings for Netlify](#netlify-toml) that make the process easier.
...
In my workflow, this means waiting to choosing from the following two options:
