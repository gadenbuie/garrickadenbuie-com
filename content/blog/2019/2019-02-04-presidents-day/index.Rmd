...
exec_time <-
  ...
  mutate(
    # Create text labels for plotly hover text
...
<details><summary style="font-size: 133%;">How This Was Made...</summary>
...
To build the plot, I first created several helper functions, set the global plot theme, and created a few constants.

<details><summary style="font-weight: bold;">Helper Functions</summary>
...
<details><summary style="font-weight: bold;">Plot Theme</summary>
...
<details><summary style="font-weight: bold;">Plot Constants</summary>
...
This visualization required downloading the President's tweets via [rtweet].
Then, I modified the previous plot to soften the coloring of the presidential activities and added the tweets.
...
And `djt_workday` contains these tweets joined with the presidential schedule, within the period covered by the Axios schedules, and during workday hours.
...
At the point, the plot is almost ready to go, except for the fact that the tooltip text will appear for the underlying activity layers.
