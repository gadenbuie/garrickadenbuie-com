...
For a bit of convienence later, I then pull out the rows of `dates` representing the first day of the month, to use later when adding the colored boxes and text labels marking the start of a new month.
