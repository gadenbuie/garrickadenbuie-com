...
twitterImage: /blog/2019/2019-08-15-custom-discrete-color-scales-for-ggplot2_files/figure-html/demo2-1.png
...
I just grabbed a color palette from [coolors.co](https://coolors.co/app/2e4057-66a182-edae49-d1495b-00798c)
(but I think it actually looks pretty decent!).
...
Next we creates the palette function. 
...
so our palette fucntion needs to have some additional parameters.
...
and the inner function returns the function of `n` that gives [ggplot2]{.pkg}
our brand's colors.
