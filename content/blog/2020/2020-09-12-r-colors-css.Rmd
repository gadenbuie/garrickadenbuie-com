...
twitterImage: https://pkg.garrickadenbuie.com/r-colors-css/social-card.png
rmd_source: ''
keywords: rstats
head_custom: |
...
which means that you can't do something like
...
I've also been very interested in utility CSS frameworks,
...
so I've been [using tachyons](https://pkg.garrickadenbuie.com/xaringanExtra/#/tachyons)
a lot lately.

Tacyhons integrates nicely with [xaringan]
...
What's awesome about Tachyons is that
it uses small, single-purpose CSS classes —
called **utility classes** —
that you can apply as you choose to your HTML elements.
...
Here are four syntax variations that use those classes.
...
1. [r-colors.css](https://pkg.garrickadenbuie.com/r-colors-css/dist/r-colors.css) — Classes for setting **foreground** and **background** colors
    - `.palevioletred1` sets the foreground color
    - `.bg-palevioletred1` sets the background color

1. [r-colors.hover.css](https://pkg.garrickadenbuie.com/r-colors-css/dist/r-colors.hover.css) — Classes for setting foreground and background colors **on hover**
    - `.palevioletred1-hover` sets the foreground color on hover
    - `.bg-palevioletred1-hover` sets the background color on hover
    
1. [r-colors.vars.css](https://pkg.garrickadenbuie.com/r-colors-css/dist/r-colors.vars.css) — [CSS variables]() for each color name
