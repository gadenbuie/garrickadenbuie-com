...
First, re-installing [shrtcts]{.pkg} will break
your currently existing keyboard shortcuts.
The next time you run `add_rstudio_addins()`
your shortcuts will return,
but the keyboard shortcuts may not survive the transition.
