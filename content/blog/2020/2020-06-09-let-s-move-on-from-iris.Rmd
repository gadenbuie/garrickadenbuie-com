...
`r blogdown::shortcode("twitter", "1268594959436804097")`
...
`r blogdown::shortcode("tweet", "1270046399418138625")`
...
_`de_iris_my_repos()` won't do anything without your express consent, but you should still probably check the R script before your source it._
