...
A little digging in the addin script ([inst/scripts/new_post.R](https://github.com/rstudio/blogdown/blob/master/inst/scripts/new_post.R)) revealed thed function behind the dropdown menu.
