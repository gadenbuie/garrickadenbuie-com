...
# From https://raw.githubusercontent.com/yihui/knitr-examples/master/063-html5-figure.Rmd
```

```{r ref.label='last-update', echo=FALSE, cache=FALSE, results='asis'}
```
...
<a href="/blog/2018/2018-02-18-gun-control-google-trends_files/figure-html/plot-normed-difficult-1.png" data-featherlight="image">
...
```{r last-update, eval=FALSE, cache=FALSE}
glue::glue("**Last updated:** {file.mtime(here::here('data/gun-control/parkland_trends.RData'))}")
```