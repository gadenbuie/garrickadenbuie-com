...
One approach is to use a baseline search term that is relatively constant across the entire period.
...
```{r plot2, dependson='normalize-trend'}
...
To the victims in Parkland, Florida and the victims of gun violence across the United States, I want you to know that **I hear you, and I stand with you.**
