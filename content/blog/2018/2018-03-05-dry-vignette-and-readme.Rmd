---
title: 'Reuse Rmd chunks in package vignettes, README, blog posts and more'
...
Using Brodie's [[vetr][gh-vetr]]{.pkg} package as an example, these files are stored in `vignettes/rmdhunks`:
...
The above examples can be extended for use in [pkgdown]{.pkg} articles (which are essentially an extension of vignettes) or for blogdown posts if you develope your package and blog source on the same machine.
