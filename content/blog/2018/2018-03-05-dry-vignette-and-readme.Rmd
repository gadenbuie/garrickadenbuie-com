...
It's a short R Markdown file with a list of (not surprisingly) related packages -- the kind of section that might be included in the both the package overview vignette and the README.
