...
I learned a few [xaringan] tricks[^rmd] I when creating [my presentation](https://www.garrickadenbuie.com/talk/trug-ggplot2/) on [ggplot2] for the [Tampa R Users Group][trug], and hopefully this blog post makes it easier to replicate than digging through the messy source of that presentation.
