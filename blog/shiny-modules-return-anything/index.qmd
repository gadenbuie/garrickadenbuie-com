...
As a community, I don' think there's a super clear consensus around when and how to teach Shiny modules.
...
The end result is that many people learn and re-learn Shiny modules at different stages of the Shiny journey.
...
The namespacing mechanism behind modules is so simple that I really wish Shiny app authors didn't have to worry about it at all.
...
In fact, it can be particularly cumbersome to think of the module's server function in the typical way, taking inputs, performing actions, and returning an output, especially when you're accustomed to leaning into Shiny's reactive programming model.
