...
![Create awesome-looking, content-dependent output styles in HTML with `knitr`'s new `class.*` chunk options.](knitr-custom-chunk.png)
...
Here's [a minimal example](demo.html) generated from this
[rmarkdown source](demo.Rmd).

```{r render, include=FALSE}
ex_rmd  <- here::here("static", "blog", "knitr-custom-class-output", "demo.Rmd")
ex_html <- here::here("static", "blog", "knitr-custom-class-output", "demo.html")
...
<iframe src="demo.html" width="100%" height="98%">
</iframe>
</div>
