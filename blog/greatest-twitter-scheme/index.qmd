...
aliases:
  - /blog/2018/08/24/greatest-twitter-scheme
description: |
  In which I investigate a very cool thing that someone claims
  to have done on Twitter. Using R and the rtweet package.
categories:
  - R
  - Twitter
  - rtweet
source_link: https://github.com/gadenbuie/garrickadenbuie-com/blob/main/content/blog/2018/2018-08-24-costcoricebag.Rmd
head_custom: |
...
<p lang="en" dir="ltr">
IS IT JUST ME, OR DID I JUST PULL OFF THE GREATEST TWITTER SCHEME OF ALL TIME?????<br><br>
Read the first word of my tweets to find out....
</p>
&mdash; Hadie Mart (<a href="https://twitter.com/CostcoRiceBag">@CostcoRiceBag</a>)
<a href="https://twitter.com/CostcoRiceBag/status/1032699857117605888">August 23, 2018</a>
</blockquote>
...
crb_tweets <- readRDS(here::here("_data/tweets_costcoricebag.rds"))
```
...
first_words %>%
  ...
  glue::glue_data('<a class="tooltip-top no-underline" data-tooltip="{text}" style="color: var(--slate-40);" href="{status_url}">{first_word}</a>') %>%
...
<blockquote class="twitter-tweet">
<p lang="en" dir="ltr">
Me: I can go to bed late, I get to sleep in tomorrow<br><br>
* gets woken by a 6am phone call *<br><br>
Welcome, to another day in the life
</p>
&mdash; Hadie Mart (<a href="https://twitter.com/CostcoRiceBag">@CostcoRiceBag</a>)
<a href="https://twitter.com/CostcoRiceBag/status/997437696476934144">May 18, 2018</a>
</blockquote>
