...
<div class="pa4 tc br-100 h4 w4 mh-auto shadow-4" style="background-size: cover; background-image: url(`r knitr::fig_chunk("resized-cropped", "png")`)">
<div class="clip">The example profile image cropped and centered to fit a circular avatar image. The subject appears directly in the middle of the circle.</div>
</div>
...
<div class="pa4 tc br-100 h4 w4 ma2 shadow-4" style="background-size: cover; background-image: url({image})">
<div class="clip">{alt}</div>
</div>'
