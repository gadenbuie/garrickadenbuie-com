...
<div class="flex-l items-center" style="">
  <div class="site-logo tr w-25 w-third-l center order-2 mr4">
    <svg
      width="32"
      height="32"
      viewBox="0 0 128 128"
  ...
  <div class="mh4 w-two-thirds-l">
    <h1 class="f2 f1-m f-subheadline-l fw5-ns mv4 lh-solid">
      Garrick Aden-Buie
    </h1>

    <div class="social-icon-links" aria-hidden="true">
      <a
        class="link dib h1 w1 ml0 mr2 f6 o-90 glow"
    ...
    <p class="f4 mt4 lh-copy">
      I’m a <strong>Data Science Educator</strong> and R developer at
      <a href="https://rstudio.com/">RStudio</a>. I use
      <a href="https://r-project.org">R</a>,
      <a href="https://rmarkdown.rstudio.com">R Markdown</a>,
      <a href="https://shiny.rstudio.com">Shiny</a>, and the tools of data
      science to help you teach and learn data science with R.
    </p>
