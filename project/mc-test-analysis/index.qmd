...
<div>
<a href="explore-01-import.png" data-featherlight="image">
  <div class="figure thumbnail">
  <img src="explore-01-import.png" alt="Load Data" width="200px">
  <p class="caption">Load Data</p>
  </div>
</a>
<a href="explore-02-ctt.png" data-featherlight="image">
  <div class="figure thumbnail">
  <img src="explore-02-ctt.png" alt="Classic Test Theory" width="200px">
  <p class="caption">Classic Test Theory</p>
  </div>
</a>
<a href="explore-03-irt.png" data-featherlight="image">
  <div class="figure thumbnail">
  <img src="explore-03-irt.png" alt="Item Response Theory" width="200px">
  <p class="caption">Item Response Theory</p>
  </div>
</a>
<a href="explore-04-factor_analysis.png" data-featherlight="image">
  <div class="figure thumbnail">
  <img src="explore-04-factor_analysis.png" alt="Factor Analysis" width="200px">
  <p class="caption">Factor Analysis</p>
  </div>
</a>
<a href="explore-05-distractor.png" data-featherlight="image">
  <div class="figure thumbnail">
  <img src="explore-05-distractor.png" alt="Distractor Analysis" width="200px">
  <p class="caption">Distractor Analysis</p>
  </div>
</a>
<a href="explore-06-report.png" data-featherlight="image">
  <div class="figure thumbnail">
  <img src="explore-06-report.png" alt="Export Report" width="200px"/>
...
[Click here to view an example report](MCTestAnalysis_Example-Report.pdf) (from synthetic data) or click the thumbnails below to view the `report()` app screens.

<div>
<a href="report-01-settings.png" data-featherlight="image">
<div class="figure thumbnail">
<img src="report-01-settings.png" alt="Import Settings" width="200px"/>
<p class="caption">Import Settings</p>
</div>
</a>
<a href="report-02-load.png" data-featherlight="image">
<div class="figure thumbnail">
<img src="report-02-load.png" alt="Load Data" width="200px"/>
<p class="caption">Load Data</p>
</div>
</a>
<a href="report-03-generate.png" data-featherlight="image">
<div class="figure thumbnail">
<img src="report-03-generate.png" alt="Generate Report" width="200px"/>
